const data = {
      sessions: [
       ...
       { 
        ...
        { 
            ...
            plaatje : "img/perspectiefhoofdwegenet.png",
   ...
   { 
          ...
          rechts : "![|max-height: 350px](img/Vanmobiliteitshubnaarherstelhub.png)",
            plaatje : "img/Vanmobiliteitshubnaarherstelhub.png",
         ...
         { 
          ...
          { 
            ...
            rechts : "![|max-height: 250px](img/kaartdoorfietsroutes2024-2.jpg)", 
              plaatje : "img/kaartdoorfietsroutes2024-2.jpg",
      ...
      { 
          ...
          spreker: "Mick van der Steeg"
            ...
            rechts : "![|max-height: 250px](img/netcongestieov.jpg)",
              plaatje : "img/netcongestieov.jpg",
      ...
      { 
          ...
          { 
            ...
            rechts : "![|max-height: 250px](img/entreezoetermeer.png)", 
              plaatje : "img/entreezoetermeer.png",
         ...
         { 
          ...
          rechts : "![|max-height: 250px](img/416-oostende-bron-nick-decombel-fotografie.jpg)", 
            plaatje : "img/416-oostende-bron-nick-decombel-fotografie.jpg",
          zaal: "Commissiezaal", 
          tijd: "16:00- 16:20", 
     ...
     { 
          ...
          rechts : "![|max-height: 250px](img/Binnenstad_Delft_Markt_fietsen langs Oud Stadhuis1.jpeg)  ",
            plaatje : "img/Binnenstad_Delft_Markt_fietsen langs Oud Stadhuis1.jpeg",
          zaal: "Eemwijk", 
          tijd: "14:40- 15:00", 
        ...
        { 
          ...
          details: "Bij ANWB AutoMaatje rijden inwoners met hun eigen auto tegen een kleine onkostenvergoeding minder mobiele mensen naar bijvoorbeeld het ziekenhuis, de kapper of familie. Zo blijven ze vaker onderweg komen ze weer (meer) onder de mensen. Meer informatie: [site Automaatje](https://www.anwb.nl/lidmaatschap/maatschappelijk/anwb-automaatje _blank). Klik voor een [korte video](https://www.youtube.com/shorts/aL5Nhe89OvY)",
           rechts : "![|max-height: 250px](img/anwb-automaatje.jpg) ",
            plaatje : "img/anwb-automaatje.jpg",
           zaal: "Cromvliet", 
          tijd: "14:40- 15:00",          
        ...
        { 
          ...
          plaatje : "img/ipo-dova_praatplaat_publieke_mobiliteit.jpg",
          zaal: "Marnixpassage", 
          tijd: "15:35 - 15:55", 
       ...
       { 
          ...
          plaatje : "https://nabogo.com/wp-content/uploads/2022/11/Group-22-min.png",
          zaal: "Cromvliet", 
          tijd: "15:05- 15:25",    
 ...
 //       },
        { 
          ...
          rechts: "![|max-height: 250px](snelstudie/img/deelfietsstudenten.jpg)",
            plaatje: "snelstudie/img/deelfietsstudenten.jpg",
