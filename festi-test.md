...
<br>
  ...
  <tbody>
    ...
    <tr>
      <td>13:30</td>
      <td>Aftrap met Christel Mourik (algemeen directeur MRDH) en Irma Kenter (domeindirecteur Bereikbaarheid, Wonen, Recreatie, Toerisme en Sport Provincie Zuid-Holland)</td>
    </tr>   
    <tr>
      <td>13:40</td>
      <td>Overzicht van deelsessies (deel 1)</td>
    </tr>       
    <tr>
      <td>13:55</td>
      <td>Provincie en regio's in gesprek over hinder van werkzaamheden en kansen die bereikbaarheid kan bieden voor de grote uitdagingen op gebied van ruimelijke ordening en woningbouw. Met Saskia Platenkamp (Drechtsteden), Raymond van Keerbergen (MRDH), Frans Jan Douglas (Holland Rijnland/gem. Leiden) en Broer Duursma (provincie)</td>
    </tr>
    <tr>
      <td>13:40</td>
      <td>overzicht rest van deelsessies</td>
    </tr>
        <tr>
      <td>13:40</td>
      <td>Parallelsessies; meer dan 25 in verschillende rondes verdeeld over tien zalen (zie hieronder)</td>
    </tr>
        <tr>
      <td>16:30</td>
      <td>Gedeputeerden Jeroen van Dijken (bereikbaarheid) & Arno Bonte (ruimtelijke ordening) blikken terug op de samenhang van ruimtelijke inrichting en bereikbaarheid. Gevolgd door Feestelijke netwerkborrel</td>
    </tr>
  </tbody>
</table>
<br>
<p>Je kunt uit meer dan 25 deelsessies kiezen. Neem hieronder alvast een kijkje. Keuze stress? Geen zorgen: Je kiest op de middag gewoon zelf waar je heen wilt. Je hoeft je niet voor sessies aan te melden.</p>
<br>

  <table>
    <thead>

        <th>Kies ter plekke uit de sessies - klik op een regel voor meer info. Zalen & tijden volgen later</th>
        <th>spreker</th>
 <!--      <th>Zaal</th> -->
...
<h2>Praktisch</h2>
<ul>
<li> Dinsdag 24 maart 2026. Inloop om 13 uur. Start programma 13:30</li>
<li> Op het provinciehuis Zuid-Holland (Zuid-Hollandplein 1, Den Haag)</li>
<li> Toegang is gratis, wel even <a href="https://festivalbereikbaarzuid-holland.pzh-events.nl/" target="_blank">aanmelden</a>
</li>
</ul>
<br>
 ...
 //         `;
    ...
    function showPopup(session) {
      sessieHTML = parse(session.details)
      if (session.rechts) { sessieHTMLrechts =   parse(session.rechts)} else {sessieHTMLrechts = ""}  

      document.getElementById('popupTitle').textContent = session.title;
      document.getElementById('popupDetails').innerHTML = sessieHTML;
      document.getElementById('popupRechts').innerHTML = sessieHTMLrechts;
