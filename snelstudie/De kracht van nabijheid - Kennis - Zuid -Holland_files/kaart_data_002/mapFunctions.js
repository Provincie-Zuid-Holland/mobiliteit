...
function createMap() {
  var layer = new L.tileLayer('https://web.archive.org/web/20251002131242/https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    attribution: '© <a href="https://web.archive.org/web/20251002131242/https://www.openstreetmap.org/copyright">OpenStreetMap</a> © <a href="https://web.archive.org/web/20251002131242/https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 18,
    id: 'mapbox/light-v10',
    tileSize: 512,
    zoomOffset: -1,
      ...
      style: function(feature) {
        var myStyle = {
         ...
         if (Instellingen["gemeentes"]=='concessie'){
           ...
           linkC1 = "https://web.archive.org/web/20251002131242/https://allecijfers.nl/gemeente/" + gem.toLowerCase();
...
/*
playback timings (ms):
  capture_cache.get: 18.82
  load_resource: 159.886
  PetaboxLoader3.resolve: 69.396
  PetaboxLoader3.datanode: 68.267
*/