...
function createMap() {
  var layer = new L.tileLayer('https://web.archive.org/web/20251002131409/https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    attribution: '© <a href="https://web.archive.org/web/20251002131409/https://www.openstreetmap.org/copyright">OpenStreetMap</a> © <a href="https://web.archive.org/web/20251002131409/https://www.mapbox.com/">Mapbox</a>',
    maxZoom: 18,
    id: 'mapbox/light-v10',
    tileSize: 512,
    zoomOffset: -1,
      ...
      style: function(feature) {
        var myStyle = {
         ...
         if (Instellingen["gemeentes"]=='concessie'){
           ...
           linkC1 = "https://web.archive.org/web/20251002131409/https://allecijfers.nl/gemeente/" + gem.toLowerCase();
...
/*
     FILE ARCHIVED ON 13:14:09 Oct 02, 2025 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 13:50:00 May 07, 2026.
...
/*
playback timings (ms):
  capture_cache.get: 0.959
  load_resource: 261.566
  PetaboxLoader3.resolve: 118.584
  PetaboxLoader3.datanode: 119.407
*/